...
stateTriangleFan::stateTriangleFan(AppWindow* ptr) : State(ptr) {
...
// -------------------- set --------------------
void stateTriangleFan::setPointsNumber(size_t newNumber){
    pointsNumber = newNumber;
}

void stateTriangleFan::setBkgColor(Fl_Color color){
    bkgColor = color;
}
    
void stateTriangleFan::setTripleColor(TripleColors tripleCol){
    colors = tripleCol;
}


// -------------------- get --------------------
size_t stateTriangleFan::getPointsNumber() const {
    return pointsNumber;
}

Fl_Color stateTriangleFan::getBkgColor() const {
    return bkgColor;
}

TripleColors stateTriangleFan::getTripleElemColor() const {
    return colors;
}
