...
void stateLineLoop::setPointsNumber(size_t newNumber){
    pointsNumber = newNumber;
}

void stateLineLoop::setLength(LineLength newLength){
    length = newLength;
}

void stateLineLoop::setBkgColor(Fl_Color color){
    bkgColor = color;
}

void stateLineLoop::setLoopColor(ElemColor newColor){
    loopColor = newColor;
}


size_t stateLineLoop::getPointsNumber() const {
    return pointsNumber;
}

LineLength stateLineLoop::getLength() const {
    return length;
}

Fl_Color stateLineLoop::getBkgColor() const {
    return bkgColor;
}

ElemColor stateLineLoop::getLoopColor() const {
    return loopColor;
}
