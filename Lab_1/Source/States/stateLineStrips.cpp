...
void stateLineStrips::setPointsNumber(size_t newNumber){
    pointsNumber = newNumber;
}

void stateLineStrips::setLength(LineLength newLength){
    length = newLength;
}

void stateLineStrips::setBkgColor(Fl_Color color){
    bkgColor = color;
}

void stateLineStrips::setElemColor(ElemColor newColor){
    stripsColor = newColor;
}


size_t stateLineStrips::getPointsNumber() const {
    return pointsNumber;
}

LineLength stateLineStrips::getLength() const {
    return length;
}

Fl_Color stateLineStrips::getBkgColor() const {
    return bkgColor;
}

ElemColor stateLineStrips::getElemColor() const {
    return stripsColor;
}
