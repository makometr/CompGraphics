...
stateQuads::stateQuads(AppWindow* ptr) : State(ptr) {
    ...
    choice_color_1->callback([](Fl_Widget* w, void* statePtr){
        ...
        stateQuads* state = static_cast<stateQuads*>(statePtr);
        assert(ch != nullptr);
...
// -------------------- set --------------------
void stateQuads::setPointsNumber(size_t newNumber){
    pointsNumber = newNumber;
}

void stateQuads::setBkgColor(Fl_Color color){
    bkgColor = color;
}
    
void stateQuads::setTetradColor(TetradColors tripleCol){
    colors = tripleCol;
}


// -------------------- get --------------------
size_t stateQuads::getPointsNumber() const {
    return pointsNumber;
}

Fl_Color stateQuads::getBkgColor() const {
    return bkgColor;
}

TetradColors stateQuads::getTetradColor() const {
    return colors;
}
