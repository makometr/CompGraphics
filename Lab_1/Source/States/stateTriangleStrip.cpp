...
stateTriangleStrip::stateTriangleStrip(AppWindow* ptr) : State(ptr) {
    ...
    choice_color_1->callback([](Fl_Widget* w, void* statePtr){
        ...
        stateTriangleStrip* state = static_cast<stateTriangleStrip*>(statePtr);
        assert(ch != nullptr);
        assert(state != nullptr);
...
// -------------------- set --------------------
void stateTriangleStrip::setPointsNumber(size_t newNumber){
    pointsNumber = newNumber;
}

void stateTriangleStrip::setBkgColor(Fl_Color color){
    bkgColor = color;
}
    
void stateTriangleStrip::setTripleColor(TripleColors tripleCol){
    colors = tripleCol;
}


// -------------------- get --------------------
size_t stateTriangleStrip::getPointsNumber() const {
    return pointsNumber;
}

Fl_Color stateTriangleStrip::getBkgColor() const {
    return bkgColor;
}

TripleColors stateTriangleStrip::getTripleElemColor() const {
    return colors;
}
